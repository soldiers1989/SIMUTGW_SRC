#ifndef __ECHO_HANDLER_H
#define __ECHO_HANDLER_H
...
class EchoHandler : public IocpEventHandler
{
private:
...
public:
	...
	//!
	//!***************************************************************************
	virtual void OnNewConnection(uint64_t cid, struct ConnectionInformation const & c);
